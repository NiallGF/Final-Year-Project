...
nhanes_files_variables = {
    ...
    'P_DIQ.xpt': ['SEQN', 'DIQ010'],  # Diabetes
    ...
    'P_CBQPFC.xpt': ['SEQN', 'CBQ506', 'CBQ860'],  # Consumer Behavior (Child)
...
critical_columns = ['LBXGH', 'LBXGLU', 'DIQ010']  # HbA1c, Glucose, Self-reported diabetes
if all(col in df.columns for col in critical_columns):
    ...
    df['diabetic'] = (
        ...
        (df['DIQ010'] == 1)  # Self-reported diabetes diagnosis
    ).astype(int)
